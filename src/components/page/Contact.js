    ...
    return (
        <>
            <div className="flex justify-center">
                <div className="mb-5">
                    <h2 className="mb-4 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                        GET IN TOUCH WITH US
                    </h2>
                    <div className='grid md:grid-cols-3 md:gap-4 sm:grid-cols-1 sm:gap-0 base:grid-cols-1 base:gap-0'>
